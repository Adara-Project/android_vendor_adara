...
custom_local_manifest = ".repo/local_manifests/adara.xml"
custom_default_revision =  os.getenv('ROOMSERVICE_DEFAULT_BRANCH', 'R')
custom_dependencies = "adara.dependencies"
org_manifest = "github/Adara-Devices"  # leave empty if org is provided in manifest
org_display = "Adara-Devices"  # needed for displaying
